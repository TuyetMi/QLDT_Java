...
class PhieuNhapHang extends FormHang {
    ...
    JTextField txMaPhieuNhap = new JTextField(12);
    JTextField txNhanVien = new JTextField(12);
    JTextField txNhaCC = new JTextField(12);
    JTextField txNgayLap = new JTextField(15);
    JTextField txGioLap = new JTextField(9);
    JTextField txTongTien = new JTextField(12);
...
class HoaDonBanHang extends FormHang {
    ...
    JTextField txMaHoaDon = new JTextField(12);
    JTextField txNhanVien = new JTextField(12);
    JTextField txNgayLap = new JTextField(9);
    JTextField txGioLap = new JTextField(10);
    JTextField txKhachHang = new JTextField(15);
    JTextField txTongTien = new JTextField(12);
    JTextField txKhuyenMai = new JTextField(12);
